...
export default (props) => {
    ...
    if (name.toLowerCase() == 'linkedin') return (
        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15" {...svgProps}>
    ...
    if (name.toLowerCase() == 'email') return (
        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 16" {...svgProps}>
    ...
    if (name.toLowerCase() == 'github') return (
        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" {...svgProps}>
